...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8d7edc8abe45e372b0ef07f014858982) *)
(*
...
let setup_t =
  {
            ...
            [
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Pl_http"; "Pl_feeds"; "Pl_posts"; "Pl_utils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ocaml_planet";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ocl_planet.ml"});
               Executable
                 ({
                     cs_name = "write-atom";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "write_atom.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\029\146\138Yüeh.\150%\030\011\0202\156\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
