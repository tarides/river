...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4424f80cec6a166834a8286d0a022d89) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ptime.clock.os", None)
                        ];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Ri_http"; "Ri_feeds"; "Ri_posts"; "Ri_utils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "river";
     ...
     oasis_digest =
       Some "\146\186\212\195\142e\217\222\161\b\212\218\213\237{I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
